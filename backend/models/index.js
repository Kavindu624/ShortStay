...
// Payment -> Payout
Payment.hasOne(Payout,            { foreignKey: 'payment_id' });
Payout.belongsTo(Payment,         { foreignKey: 'payment_id' });

// User (host) -> Payout
User.hasMany(Payout,              { foreignKey: 'host_id', as: 'payouts' });
Payout.belongsTo(User,            { foreignKey: 'host_id', as: 'host' });

// Booking -> Payout
Booking.hasOne(Payout,            { foreignKey: 'booking_id' });
Payout.belongsTo(Booking,         { foreignKey: 'booking_id' });

// Payment -> Dispute
Payment.hasMany(Dispute,          { foreignKey: 'payment_id', as: 'disputes' });
Dispute.belongsTo(Payment,        { foreignKey: 'payment_id' });

// User -> Dispute (raised_by)
User.hasMany(Dispute,             { foreignKey: 'raised_by', as: 'raised_disputes' });
Dispute.belongsTo(User,           { foreignKey: 'raised_by', as: 'raised_by_user' });
