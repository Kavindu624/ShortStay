...
exports.getAllProperties = async (req, res) => {
  try {
    const { 
      ...
      // Distance filter
      // These come from Google Maps Geocoding on frontend
      // Frontend converts location text → lat/lng → sends here
      location_lat,    // latitude of searched location
      location_lng,    // longitude of searched location
