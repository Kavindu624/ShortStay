...
CREATE TABLE `dispute` (
  ...
  `resolved_by` int DEFAULT NULL COMMENT 'user_id of payment_manager',
...
CREATE TABLE `payout` (
  ...
  `processed_by` int DEFAULT NULL COMMENT 'user_id of payment_manager',
  `notes` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `staff` (
  ...
  `area_assigned` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'For field_inspector — their coverage area',
  `transaction_limit` decimal(10,2) DEFAULT NULL COMMENT 'For payment_manager — max transaction they can approve',
...
CREATE TABLE `user` (
  ...
  `role` enum('guest','host','admin','payment_manager','field_inspector') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
